    ...
    <View className="flex-1" >
      ...
      <View className="rounded-t-3xl -mt-12 bg-white relative">
        ...
        <View className="flex-row justify-between px-5 pt-10">
          ...
          <FastImage className="h-24 w-24" source={require('../assets/images/bikeGuy2.gif')} />
        </View>
        ...
        <View
          ...
          <View style={{ backgroundColor: 'rgba(255,255,255,0.4)' }} className="p-1 rounded-full">
            <FastImage style={{ backgroundColor: 'rgba(255,255,255,0.4)' }} className="w-16 h-16 rounded-full" source={require('../assets/images/deliveryGuy.png')} />
          </View>
